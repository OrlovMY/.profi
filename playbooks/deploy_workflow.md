...
Тег на задеплоенный build и provenance-запись — обязательны: `knowledge/standards/deploy-provenance-and-build-integrity.md`, §5–§6 (immutable git-tag на выкаченный артефакт; запись commit→куда→когда→исход проверки).
...
История правок: `archive/2026-08/PE-01-разбор-2026-08-24.md`, раздел «Совместная редакция и применение», П1; вердикты — `archive/2026-08/PQ-01-разбор-2026-08-24.md`; 2026-08-24.

История правок: `archive/2026-08/ревизия-свода-2026-08-24.md`, П7 (вход-потребитель сведён в ссылку на дом — `playbooks/resource_tracking.md`); вердикты — `archive/2026-08/PQ-01-ревизия-2026-08-24.md`; 2026-08-24.
...
История правок: `archive/2026-08/ревизия-свода-2026-08-24.md`, раздел 13, Б5 (вход к тегу и provenance-записи — §5–§6 стандарта); вердикты — `archive/2026-08/PQ-01-ревизия-2026-08-24.md`, «Дополнение по разделу 13»; 2026-08-25.
