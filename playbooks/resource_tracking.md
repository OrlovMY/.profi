...
История правок: `ревизия-свода-2026-08-24.md`, П7 (в редакции PQ-01 — журнал ресурсов привязан к приёмке отчёта deploy-агента И записи разбора инцидента; возврат в работу по `attach-recurring-step-to-mandatory-action.md`); вердикты — `PQ-01-ревизия-2026-08-24.md`; 2026-08-24.
