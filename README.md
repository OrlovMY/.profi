...
- `roles/` — промпты-роли. Каждый файл = системный промпт для одного агента.
  ...
  - `big7/` — ядро принятия решений: PM/AR/BE/SEC-01/DO/QA-01 + SEC-02 + UX-01 + UI-01 + QA-02. См. `big7/INDEX.md`.
...
6. **Большая 9** — обязательная консультация перед нетривиальной работой: PM-01, AR-01, BE-01, SEC-01, DO-01, QA-01, SEC-02, UX-01, UI-01.
   UX-01 и UI-01 подключаются к КАЖДОМУ изменению интерфейса, а не только к крупным: их предмет — то, что накапливается по мелочи.
